...
const GRBL_MM: PostProcessorProfile = {
  ...
  toolChangeGcode: 'M5 ; spindle off (tool change)',
  spindleOnTemplate: 'M3 S{s} ; spindle on',
  spindleOffGcode: 'M5 ; spindle off',
...
const GRBL_IN: PostProcessorProfile = {
  ...
  unitMode: 'in',
  commentStyle: 'semicolon',
  startGcode: 'G20 ; inches\nG90 ; absolute\nG17 ; XY plane',
  endGcode: 'M5\nG0 Z0.400 ; safe retract\nM30 ; end',
  toolChangeGcode: 'M5 ; spindle off (tool change)',
  spindleOnTemplate: 'M3 S{s} ; spindle on',
  spindleOffGcode: 'M5 ; spindle off',
  rapidTemplate: 'G0 X{x} Y{y} Z{z}',
